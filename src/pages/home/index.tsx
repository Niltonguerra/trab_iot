...
<main className='px-16 py-6 bg-gray-100 md:col-span-2'>
  <div className='flex justify-center md:justify-end'>
    <a href="/" className='transition duration-500 ease-out btn text-primary md:border-primary md:border-2 hover:bg-primary hover:text-white'>Log in</a>
    <a href="/" className='ml-2 transition duration-500 ease-out btn text-primary md:border-primary md:border-2 hover:bg-primary hover:text-white'>Sign up</a>
  </div>
