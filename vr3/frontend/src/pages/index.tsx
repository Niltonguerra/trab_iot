        ...
        <nav className='text-right'>
          <div className='flex items-center justify-between'>
            ...
            <h1 className='p-4 font-bold uppercase border-b border-none'>
              <Link to="/" className='hover:text-gray-800 border-none'>Fruit + vegetables</Link>
            </h1>
...
<main className='px-16 py-6 bg-gray-100 md:col-span-2'>
  <div className='flex justify-center md:justify-end'>
    <Link to="/login" className='transition duration-500 ease-out btn text-primary md:border-primary md:border-2 hover:primary hover:text-white border-none hover:bg-primary'>Log in</Link>
